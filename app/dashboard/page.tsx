    ...
    <div className="min-h-screen bg-[#f6f9ff] text-[#0f172a]">
      ...
      <header className="h-16 bg-white shadow-sm flex items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-3">
          <button aria-label="Menu" className="p-2 rounded-md hover:bg-gray-100" onClick={() => setIsSidebarCollapsed((v) => !v)}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#0f172a]">
            ...
            <div className="flex items-center">
              <div className='leading-tight'>
                <Image src={medtechHeader} alt='Medtech' width={140} height={140} priority />
              </div>
            </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button className="p-2 rounded-full hover:bg-gray-100" aria-label="Notifications">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#475569]">
          ...
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 bg-blue-100 rounded-full grid place-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-blue-600">
                <path fillRule="evenodd" d="M18 8a6 6 0 11-12 0 6 6 0 0112 0zM3.75 20.25a8.25 8.25 0 0116.5 0v.75H3.75v-.75z" clipRule="evenodd" />
              </svg>
            </div>
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`${isSidebarCollapsed ? 'w-20' : 'w-72'} hidden md:block bg-white min-h-[calc(100vh-64px)] border-r transition-all duration-200`}>
          <nav className="p-6">
            <Link href="#" className="flex items-center gap-3 text-[#0f172a] hover:text-blue-600 mb-6">
            ...
            {!isSidebarCollapsed && (
              <div className="text-xs text-slate-400 uppercase tracking-wide mb-2">Main</div>
            )}
            <Link href="#" className="flex items-center gap-3 text-[#0f172a] hover:text-blue-600">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-blue-600">
                <path d="M12 2.25c-2.485 0-4.5 2.015-4.5 4.5S9.515 11.25 12 11.25s4.5-2.015 4.5-4.5S14.485 2.25 12 2.25z" />
                <path fillRule="evenodd" d="M2.25 20.25a9.75 9.75 0 1119.5 0v.75H2.25v-.75z" clipRule="evenodd" />
              </svg>
              {!isSidebarCollapsed && <span className="font-medium">Anemia Screening</span>}
            </Link>
          </nav>
        </aside>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-[#eef2ff] grid place-items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 text-[#6366f1]">
                    <path fillRule="evenodd" d="M18 8a6 6 0 11-12 0 6 6 0 0112 0zM3.75 20.25a8.25 8.25 0 0116.5 0v.75H3.75v-.75z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="text-3xl font-extrabold tracking-tight text-[#0f172a]">145</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-3xl font-extrabold tracking-tight text-green-600">3,264</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-3xl font-extrabold tracking-tight text-orange-500">1244</div>
              </div>
            </div>
          </div>
